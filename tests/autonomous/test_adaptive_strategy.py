...
class TestStrategyAdaptation:
    ...
    def test_adapt_for_waf(self):
        ...
        adapted = self.engine._adapt_for_waf(
            self.base_strategy,
    ...
    def test_adapt_for_rate_limit(self):
        ...
        adapted = self.engine._adapt_for_rate_limit(
            self.base_strategy,
            {},
            attempt=1
        )
    ...
    def test_adapt_for_auth(self):
        ...
        assert adapted.get("try_default_credentials") == True
    ...
    def test_adapt_for_payload_detection(self):
        ...
        adapted = self.engine._adapt_for_payload_detection(
            self.base_strategy, {}, attempt=1
        )
