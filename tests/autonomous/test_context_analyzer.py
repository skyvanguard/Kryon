...
class TestContextAnalysis:
    ...
    def test_credentials_discovered(self):
        ...
        target_data = {
            "logs": "mysql://user:pass123@localhost/db"
        }
    ...
    def test_recommended_actions_generated(self):
        ...
        target_data = {
            "recon_output": "TODO: Patch vulnerable service on port 8080"
        }
...
class TestHintFollowing:
    ...
    def test_multiple_hints(self):
        ...
        hints = [
            ...
            {"type": "credential_hint", "content": "Default password: admin123", "confidence": 0.85},
    ...
    def test_priority_assignment(self):
        ...
        hints = [
            {"type": "vulnerability_hint", "content": "Critical RCE vulnerability", "confidence": 0.95},
        ...
        high_conf_task = next((t for t in tasks if "rce" in t["action"].lower() or "vulnerability" in t["action"].lower()), None)
        if high_conf_task:
    ...
    def test_tool_recommendation(self):
        ...
        hints = [
            {"type": "vulnerability_hint", "content": "SQL injection on /login", "confidence": 0.9}
        ]
...
class TestSecretExtraction:
    ...
    def test_extract_email(self):
        ...
        result = analyzer.autonomous_context_analysis(
            target_data={"text": text},
            operation_objective="general"
        )
