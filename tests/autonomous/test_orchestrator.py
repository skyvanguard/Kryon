...
class TestAutonomousCTFSolver:
    ...
    def test_complete_ctf_workflow_success(
        ...
        mock_analyzer.autonomous_context_analysis.return_value = {
            ...
            "attack_surface": {"endpoints": ["/admin", "/api"]},
        }
    ...
    def test_credentials_discovery(self, mock_learned, mock_analyzer_class, mock_planner_class, mock_recon):
        ...
        mock_analyzer_class.return_value = mock_analyzer
        mock_analyzer.autonomous_context_analysis.return_value = {
            "credentials": [{"username": "admin", "password": "admin123", "service": "ssh"}],
            "hints": [],
            "attack_surface": {"endpoints": []},
        }
    ...
    def test_multiple_services_enumeration(
        ...
        mock_exploit_select.side_effect = [
            {
                "exploit_recommended": True,
                "exploit_name": "apache_exploit",
                "exploit_type": "rce",
                "success_probability": 0.8,
            },
            {
                "exploit_recommended": True,
                "exploit_name": "ssh_exploit",
                "exploit_type": "auth_bypass",
                "success_probability": 0.6,
            },
            {
                "exploit_recommended": True,
                "exploit_name": "mysql_exploit",
                "exploit_type": "auth_bypass",
