...
class TestFullAutoEnumeration:
    ...
    def test_basic_enumeration_success(self, mock_detect, mock_scan):
        ...
        mock_scan.return_value = {
            "success": True,
            "ports": [
                {"port": 80, "service": "http", "version": "Apache 2.4", "state": "open", "protocol": "tcp"},
                {"port": 22, "service": "ssh", "version": "OpenSSH 7.6", "state": "open", "protocol": "tcp"}
            ],
            "os": {"type": "Linux"}
        }
        ...
        mock_detect.return_value = {
            "services": [
                {"name": "http", "port": 80, "version": "Apache 2.4", "banner": None, "protocol": "tcp"},
                {"name": "ssh", "port": 22, "version": "OpenSSH 7.6", "banner": "SSH-2.0-OpenSSH_7.6", "protocol": "tcp"}
            ]
        }
    ...
    def test_web_enumeration_triggered(self, mock_web, mock_detect, mock_scan):
        ...
        mock_scan.return_value = {
            "success": True,
            "ports": [{"port": 80, "service": "http", "version": "nginx 1.18", "state": "open", "protocol": "tcp"}],
            "os": {}
        }

        mock_detect.return_value = {
            "services": [{"name": "http", "port": 80, "version": "nginx 1.18", "banner": None, "protocol": "tcp"}]
        }
    ...
    def test_vulnerability_assessment_in_deep_scan(self, mock_vuln, mock_detect, mock_scan):
        ...
        mock_scan.return_value = {
            "success": True,
            "ports": [{"port": 80, "service": "http", "version": "Apache 2.4.49", "state": "open", "protocol": "tcp"}],
            "os": {}
        }

        mock_detect.return_value = {
            "services": [{"name": "http", "port": 80, "version": "Apache 2.4.49", "banner": None, "protocol": "tcp"}]
        }
...
class TestVulnerabilityAssessment:
    ...
    def test_vulnerability_assessment_no_vulns(self):
        ...
        services = [
            {"name": "http", "port": 80, "version": "Apache 2.4.52", "banner": None}
        ]
...
class TestPerformance:
    ...
    def test_timeout_respected(self, mock_detect, mock_scan, mock_web):
        ...
        mock_scan.return_value = {
            "success": True,
            "ports": [{"port": 80, "service": "http", "version": "Apache 2.4", "state": "open", "protocol": "tcp"}],
            "os": {}
        }
