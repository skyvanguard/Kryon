...
def test_to_input_items_for_message() -> None:
    ...
    message = ResponseOutputMessage(id="m1", content=[content], role="assistant", status="completed", type="message")
...
def test_to_input_items_for_function_call() -> None:
    ...
    tool_call = ResponseFunctionToolCall(id="f1", arguments="{}", call_id="c1", name="func", type="function_call")
...
def test_to_input_items_for_file_search_call() -> None:
    ...
    fs_call = ResponseFileSearchToolCall(id="fs1", queries=["query"], status="completed", type="file_search_call")
