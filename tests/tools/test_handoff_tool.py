...
async def test_handoff_input_type():
    ...
    invoked = await obj.on_invoke_handoff(RunContextWrapper(agent), Foo(bar="baz").model_dump_json())
...
def test_handoff_input_schema_is_strict():
    ...
    assert "additionalProperties" in obj.input_json_schema and not obj.input_json_schema["additionalProperties"], (
