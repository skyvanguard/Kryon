...
Coverage:
  ...
  - Drift test: app.example.com-like profile (TLS 1.3 + LE R13)
...
def test_cashbox_example_like_profile_minimal_findings():
    """Profile resembling app.example.com (TLS 1.3 + AES-256-GCM
