...
Coverage:
  ...
  - **Critical: drift-detection test reproducing the 6 findings
    detected manually on cashbox.britimp.com.py — closes the loop
...
# =====================================================================
# DRIFT-DETECTION: cashbox.britimp.com.py reproduction
# =====================================================================


def test_cashbox_britimp_reproduces_six_findings():
    """**Critical test**: reproduce the exact 6 findings detected
    manually during validation against https://cashbox.britimp.com.py/.
    ...
    # These are the exact response headers cashbox.britimp.com.py
    # returned during the May 2026 validation probe.
    r = HTTPResponse(
        url="https://cashbox.britimp.com.py/",
        method="GET",
        is_https=True,
        headers={
