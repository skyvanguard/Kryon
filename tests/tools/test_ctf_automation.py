...
class TestAutoEnumerateTarget:
    ...
    def test_web_service_detection(self, mock_subprocess):
        ...
        assert "http://10.10.245.67:80" in result['web_services'] or \
               "https://10.10.245.67:443" in result['web_services']
...
class TestHuntFlags:
    ...
    def test_flag_pattern_matching(self, mock_subprocess):
        ...
        mock_subprocess.return_value = Mock(
            returncode=0,
            stdout="/var/www/flag.txt:THM{custom_flag_pattern}"
        )
...
class TestTryHackMeHelpers:
    ...
    def test_check_thm_vpn_connected(self, mock_subprocess):
        ...
        mock_subprocess.return_value = Mock(
            returncode=0,
            stdout="inet 10.10.245.100 netmask 255.255.254.0"
        )
