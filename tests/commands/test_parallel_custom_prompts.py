...
# Set test environment variable to avoid OpenAI client initialization errors
...
class TestParallelCustomPrompts:
    ...
    def test_prompt_subcommand_adds_prompt_to_config(self):
        ...
        # Verify success message was printed (check for prompt update message)
        print_calls = [str(call) for call in mock_console.print.call_args_list]
        assert any("Updated prompt" in str(call) for call in print_calls)
