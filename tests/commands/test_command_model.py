...
class TestModelCommand:
    ...
    @patch("requests.get")
    def test_handle_no_args_with_mock_data(self, mock_get, model_command, mock_litellm_response, mock_ollama_response):
...
class TestModelShowCommand:
    ...
    @patch("requests.get")
    def test_handle_no_args(self, mock_get, model_show_command, mock_litellm_response, mock_ollama_response):
