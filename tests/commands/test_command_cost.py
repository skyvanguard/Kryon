...
class TestCostCommand:
    ...
    def temp_usage_file(self):
        ...
        # Create file and close it completely before yielding
        # This ensures the file is readable on Windows
    ...
    def test_handle_reset_with_confirmation(self, mock_global_tracker, cost_command, mock_console, temp_usage_file):
        ...
        mock_global_tracker.enabled = True
        mock_global_tracker.get_summary.return_value = {"global_totals": {"total_cost": 1.234567, "total_sessions": 10}}
