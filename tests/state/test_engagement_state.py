...
def test_slug_strips_scheme():
    assert target_slug("https://www.britimp.com.py") == "www.britimp.com.py"


def test_slug_handles_port_and_path():
    assert target_slug("https://www.britimp.com.py:443/admin") == "www.britimp.com.py_443_admin"
...
def test_slug_lowercases():
    assert target_slug("WWW.BRITIMP.COM.PY") == "www.britimp.com.py"
