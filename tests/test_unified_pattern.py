...
class TestFactoryFunctions:
    ...
    def test_hierarchical_pattern_factory(self):
        ...
        pattern = hierarchical_pattern("test", "root", "Test pattern", children=["child1", "child2"])
    ...
    def test_conditional_pattern_factory(self):
        ...
        pattern = conditional_pattern("test", {"cond1": "agent1", "cond2": "agent2"}, "Test pattern")
...
class TestPatternMetadata:
    ...
    def test_pattern_with_metadata(self):
        ...
        pattern = Pattern("test", type=PatternType.PARALLEL, metadata={"version": "1.0", "author": "test"})
