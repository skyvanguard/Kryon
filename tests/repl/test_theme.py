"""TDD contract for kryon.repl.ui.theme — Kryon crystalline identity.

Theme module exposes:
  - Semantic constants (electric-cyan + steel-blue accents, dims for context)
...
def test_palette_uses_crystalline_accents() -> None:
    from kryon.repl.ui import theme

    # Crystalline identity: electric-cyan #45e0ef primary, steel-blue
    # #2f6ea6 secondary (matches assets/kryon-mark.svg).
    assert "#45e0ef" in theme.ACCENT_PRIMARY
    assert "#2f6ea6" in theme.ACCENT_SECONDARY
