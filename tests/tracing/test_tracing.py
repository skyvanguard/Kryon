...
from kryon.sdk.agents.tracing import (
    Span,
    Trace,
    agent_span,
    custom_span,
...
from kryon.sdk.agents.tracing.spans import SpanError
...
def standard_span_checks(span: Span[Any], trace_id: str, parent_id: str | None, span_type: str) -> None:
