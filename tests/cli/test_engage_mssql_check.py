...
Surface ground truth POC Example 2026-05-18 contra .15: Microsoft
...
con stack Microsoft (Example incluido) quedaba sin deteccion
...
class TestMssqlResolution:
    def test_example_h15_scenario(self):
