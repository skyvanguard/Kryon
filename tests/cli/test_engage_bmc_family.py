...
Regression test for the false-positive observed in the Example POC pilot
on 2026-05-18: HP iLO at 192.0.2.223 was mis-classified as Linux
...
class TestHpIloDetection:
    def test_ilo_banner_on_ssh_promotes_bmc_and_suppresses_linux(self):
        """HP iLO at 192.0.2.223 — the regression case."""
        services = [
...
class TestWindowsSshDoesNotTriggerLinux:
    """The case from .13 in the Example POC: Windows host running
...
class TestUnifiAndFortigateDisambiguation:
    """The .8 case from the Example POC: UniFi Controller on :8443
