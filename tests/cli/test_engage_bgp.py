...
Surfaced POC Britimp BASE .203.1: router edge con TCP/179 abierto al
...
class TestBgpDetection:
    ...
    def test_port_179_with_tcpwrapped_still_flags(self):
        """Britimp .203.1 case: nmap reported tcpwrapped, no banner."""
    ...
    def test_remediation_mentions_multiple_vendors(self):
        """Cisco / Juniper / FortiGate / MikroTik — Britimp tiene FortiGate
