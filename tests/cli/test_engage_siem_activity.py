...
Surfaced POC Example 2026-05-19: Wazuh VM-Ubuntu-Wazuh STOPPED en el
...
# ---------------------------------------------------------------------------
# CRITICAL — Wazuh installed pero apagado (POC Example case)
# ---------------------------------------------------------------------------


class TestWazuhInstalledButInactive:
    def test_example_wazuh_apagado_es_critical(self):
        """The exact POC Example case: VM-Wazuh STOPPED -> agents en
