...
Regression detectada en el POC piloto Britimp 2026-05-18 contra .200:
...
class TestCriticalDirectoryListing:
    def test_britimp_h200_scenario(self):
...
class TestProxmoxBannerDetect:
    ...
    Validates against the Britimp .200 scenario (real Proxmox with
