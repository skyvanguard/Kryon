...
Surfaceado en el POC piloto de Example 2026-05-18 contra .123, una
...
class TestSpaCatchAll:
    def test_angular_spa_identical_body_no_flag(self):
        """The exact case from .123 (Example Registro de Visitas SPA)."""
        spa_body = "<!doctype html><html><base href='/'><body>Example</body></html>"
        responses = {
            "/admin": (200, spa_body),
            "/": (200, spa_body),
        }
