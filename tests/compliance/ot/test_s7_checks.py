...
class TestS7_11AnonSession:
    def test_pass_when_unreachable(self, monkeypatch: pytest.MonkeyPatch) -> None:
        ...
        _stub_enum(monkeypatch, S7EnumResult(
            host="10.0.0.5", port=102, reachable=False,
            cotp_connected=False, s7_session_established=False,
    ...
    def test_fail_when_session_established(
        ...
        _stub_enum(monkeypatch, S7EnumResult(
            host="10.0.0.5", port=102, reachable=True,
            cotp_connected=True, s7_session_established=True,
    ...
    def test_pass_when_s7_setup_rejected(
        ...
        _stub_enum(monkeypatch, S7EnumResult(
            host="10.0.0.5", port=102, reachable=True,
            cotp_connected=True, s7_session_established=False,
