"""Structural tests for the SWIFT CSP v2026 framework (F40)."""
...
_YAML_PATH = (
    Path(__file__).resolve().parents[2] / "src" / "kryon" / "compliance" / "cis" / "frameworks" / "swift-csp-2026.yaml"
)
...
def test_yaml_loads(framework):
    assert framework.metadata.id == "swift-csp-2026"
