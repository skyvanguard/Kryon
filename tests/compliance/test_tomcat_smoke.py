...
# ---------------------------------------------------------------------------
# Britimp regression scenario — Tomcat 7.0.34 with everything wide open
# ---------------------------------------------------------------------------


def test_britimp_h11_tomcat_7_0_34_full_scenario(monkeypatch):
    ...
    _patch_fp(monkeypatch, britimp_fp)
