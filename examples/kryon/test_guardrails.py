...
async def test_guardrails():
    ...
    try:
        await Runner.run(one_tool_agent, safe_input)
    ...
    try:
        await Runner.run(one_tool_agent, injection1)
        print("❌ Injection was NOT blocked (this is bad!)")
    except InputGuardrailTripwireTriggered:
    ...
    try:
        await Runner.run(one_tool_agent, injection2)
        print("❌ Subtle injection was NOT blocked")
    except InputGuardrailTripwireTriggered:
        print("✅ Subtle injection blocked successfully!")
