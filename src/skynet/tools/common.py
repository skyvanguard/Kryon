...
# The actual implementation is in skynet.tools.reconnaissance.generic_linux_command
...
def _get_agent_token_info():
    ...
    try:
        ...
        from skynet.sdk.agents.models.openai_chatcompletions import ACTIVE_MODEL_INSTANCES
...
async def _run_local_async(
    ...
    try:
        ...
        if stream and call_id:
            from skynet.util import finish_tool_streaming
...
async def run_command_async(
    ...
    from skynet.cli import ctf_global
...
# Late import to avoid circular imports - placed at end of module
# Re-export generic_linux_command for backward compatibility with files that import from common
