...
def john_generate_rules(
    output_file: str = "/tmp/skynet_john_rules.conf", target_type: str = "ctf"
) -> Dict[str, Any]:
    """
    ...
    try:
        ...
        if target_type == "ctf":
            ...
            results["rule_description"] = (
                "CTF-optimized rules with leet speak, common suffixes, and flag formats"
            )
            results["examples"] = [
                "password -> Password",
            ...
            results["rule_description"] = (
                "Corporate password policy rules with complexity requirements"
            )
            results["examples"] = [
                "company -> Company1!",
                "password -> Password2024!",
