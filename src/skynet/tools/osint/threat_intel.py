...
def virustotal_search(query: str, query_type: str = "domain", api_key: str = "", ctf=None) -> str:
    """
...
@function_tool
@cache_scan_result(scan_type="osint_data", ttl=86400)
def spiderfoot_scan(target: str, scan_type: str = "all", output_file: str = "", ctf=None) -> str:
    """
...
def censys_search(query: str, search_type: str = "hosts", max_results: int = 100, ctf=None) -> str:
    """
