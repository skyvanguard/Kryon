...
@function_tool
def central_core(breakdowns: str = "", reflection: str = "",  # pylint: disable=too-many-arguments  # noqa: E501
...
@function_tool
def think(central_core: str) -> str:  # pylint: disable=unused-argument
    """
    Use the tool to think about something.
    
    It will not obtain new information or change the database, but just append
    the central_core to the log. Use it when complex reasoning or some cache memory
    is needed.
    
    Args:
        central_core: A central_core to think about.
    Returns:
        str: The central_core that was processed
    """
    return f"{central_core}"
