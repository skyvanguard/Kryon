...
@function_tool
def objection_explore(package_name: str, command: str = "", device_id: str = "", spawn: bool = True, ctf=None) -> str:
    """
...
@function_tool
def objection_bypass_root(package_name: str, device_id: str = "", ctf=None) -> str:
    """
