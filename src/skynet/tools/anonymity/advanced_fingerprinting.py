...
def hardware_fingerprint_evasion(
    ...
    Example:
        >>> from skynet.tools.anonymity import hardware_fingerprint_evasion
        >>>
...
def font_fingerprinting_prevention(
    randomize_fonts: bool = True, font_set: str = "common"
) -> Dict[str, Any]:
    """
    ...
    Example:
        >>> from skynet.tools.anonymity import font_fingerprinting_prevention
        >>>
...
def audio_context_spoofing() -> Dict[str, Any]:
    ...
    Example:
        >>> from skynet.tools.anonymity import audio_context_spoofing
        >>>
...
def battery_api_randomization() -> Dict[str, Any]:
    ...
    Example:
        >>> from skynet.tools.anonymity import battery_api_randomization
        >>>
...
def tls_fingerprint_randomization(
    ...
    Example:
        >>> from skynet.tools.anonymity import tls_fingerprint_randomization
        >>>
    ...
    try:
        ...
        ja3_string = (
            f"771,{'-'.join(map(str, results['extensions']))},{'-'.join(results['curves'])}"
        )
...
def http2_fingerprint_evasion() -> Dict[str, Any]:
    ...
    Example:
        >>> from skynet.tools.anonymity import http2_fingerprint_evasion
        >>>
...
def sensor_api_spoofing(
    sensors: List[str] = ["accelerometer", "gyroscope", "magnetometer"],
) -> Dict[str, Any]:
    """
    ...
    Example:
        >>> from skynet.tools.anonymity import sensor_api_spoofing
        >>>
        >>> # Spoof all sensors
...
def media_device_randomization() -> Dict[str, Any]:
    ...
    Example:
        >>> from skynet.tools.anonymity import media_device_randomization
        >>>
...
def performance_api_fuzzing() -> Dict[str, Any]:
    ...
    Example:
        >>> from skynet.tools.anonymity import performance_api_fuzzing
        >>>
...
def plugin_enumeration_blocking() -> Dict[str, Any]:
    ...
    Example:
        >>> from skynet.tools.anonymity import plugin_enumeration_blocking
        >>>
