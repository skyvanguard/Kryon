...
def wmiexec_execute(target: str, username: str, password: Optional[str] = None,
                    ntlm_hash: Optional[str] = None, domain: Optional[str] = ".",
...
def smbexec_execute(target: str, username: str, password: Optional[str] = None,
                    ntlm_hash: Optional[str] = None, domain: Optional[str] = ".",
                    command: str = "whoami") -> Dict[str, Any]:
...
def dcomexec_execute(target: str, username: str, password: Optional[str] = None,
                     ntlm_hash: Optional[str] = None, domain: Optional[str] = ".",
                     command: str = "whoami", object_type: str = "MMC20") -> Dict[str, Any]:
...
def ssh_execute(target: str, username: str, password: Optional[str] = None,
                key_file: Optional[str] = None, command: str = "whoami",
...
def winrm_execute(target: str, username: str, password: str, domain: Optional[str] = ".",
                  command: str = "whoami", port: int = 5985, ssl: bool = False) -> Dict[str, Any]:
