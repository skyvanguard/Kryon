...
def psexec_lateral_movement(
    ...
    try:
        ...
        results["error"] = (
            "impacket-psexec not found - install with: apt-get install impacket-scripts"
        )
...
def _test_share_access(
    host: str, share: str, username: Optional[str], password: Optional[str]
) -> Dict[str, bool]:
