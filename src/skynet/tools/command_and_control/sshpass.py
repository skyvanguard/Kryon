...
in `generic_linux_command` and in `execute_cli_command` -> `skynet.tools.misc.cli_utils`
...
from skynet.tools.common import run_command  # pylint: disable=E0401 # noqa: E501
