...
# Local imports
from skynet.agents.meta.local_python_executor import (
    BASE_BUILTIN_MODULES,
    LocalPythonInterpreter,
    fix_final_answer_code,
    truncate_content,
)
from skynet.sdk.agents import Agent, Result
...
def parse_code_blobs(text: str) -> str:
    ...
    if not matches:
        ...
        if "def " in text or "import " in text or "print(" in text:
            ...
            code_lines = []
            for line in lines:
                if line.strip().startswith(("def ", "import ", "from ", "print(", "#", "for ", "if ")):
        ...
        try:
            ...
            if is_windows:
                ...
                if thread.is_alive():
                    ...
                    result_message += (
                        "Please optimize your code to run more efficiently or break it into smaller steps."
                    )
