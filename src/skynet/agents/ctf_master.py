...
from skynet.tools.dfir.memory_forensics import volatility_analyze  # pylint: disable=import-error
from skynet.tools.osint.shodan_api import shodan_search  # pylint: disable=import-error

# Phase 12: OSINT Tools (for target intelligence)
from skynet.tools.osint.theharvester import theharvester_scan  # pylint: disable=import-error
...
from skynet.tools.wireless.aircrack import aircrack_crack_wpa  # pylint: disable=import-error
...
ctf_arsenal = [
    ...
    aircrack_crack_wpa,  # WiFi password cracking
