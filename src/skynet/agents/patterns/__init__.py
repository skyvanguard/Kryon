    ...
    for _importer, modname, ispkg in pkgutil.iter_modules(__path__, prefix):
        ...
        try:
            ...
            for attr_name in dir(module):
                ...
                elif isinstance(attr, dict) and "name" in attr and "type" in attr and attr_name.endswith("_pattern"):
...
def create_pattern(name: str, pattern_type: Union[str, "PatternType"], description: str = "", **kwargs) -> "Pattern":
