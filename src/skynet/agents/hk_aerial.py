...
from skynet.sdk.agents import (  # pylint: disable=import-error
    Agent,
...
from skynet.tools.network.capture_traffic import capture_remote_traffic, remote_capture_session
