...
class AutoUpdater:
    ...
    def start(
        ...
        print(f"✅ Auto-updater started ({schedule_type} at {time_of_day if schedule_type != 'hourly' else 'every hour'})")
    ...
    def _update_from_source(self, source: str) -> int:
        ...
        """
        from .scrapers import ExploitDBScraper, NVDScraper, GitHubScraper, WriteupScraper
