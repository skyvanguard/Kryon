...
class MetadataExtractor:
    ...
    def _extract_tools(self, content: str) -> List[str]:
        ...
        tools = [
            "nmap", "metasploit", "burp suite", "sqlmap", "nikto",
            "gobuster", "dirbuster", "hydra", "john", "hashcat",
            "netcat", "nc", "socat", "wireshark", "tcpdump",
            "nessus", "openvas", "bloodhound", "mimikatz", "powersploit",
            "empire", "covenant", "cobalt strike", "linpeas", "winpeas",
