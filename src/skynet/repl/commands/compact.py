...
from skynet.repl.commands.model import (
...
class CompactCommand(Command):
    ...
    def handle_model(self, args: Optional[list[str]] = None) -> bool:
        ...
        if not args:
            ...
            self.cached_model_numbers = {str(i): model["name"] for i, model in enumerate(ALL_MODELS, 1)}
    ...
    def _perform_parallel_compaction(self) -> bool:
        ...
        from skynet.repl.commands.parallel import PARALLEL_CONFIGS
        from skynet.sdk.agents.models.openai_chatcompletions import get_agent_message_history
