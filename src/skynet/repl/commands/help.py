...
try:
    ...
    raise ImportError("The 'rich' package is required. Please install it with: pip install rich") from exc

from skynet.repl.commands.base import COMMAND_ALIASES, COMMANDS, Command, register_command

try:
    from skynetextensions.platform.base import platform_manager as _  # noqa: F401

    HAS_PLATFORM_EXTENSIONS = True
except ImportError:
    HAS_PLATFORM_EXTENSIONS = False

from skynet.compat import is_skynet_extensions_platform_available
...
class HelpCommand(Command):
    ...
    def handle_help_memory(self) -> bool:
        ...
        # Usage table
        usage_table = create_styled_table("Usage", [("Command", "yellow"), ("Description", "white")])
        ...
        # Examples table
        examples_table = create_styled_table("Examples", [("Example", "cyan"), ("Description", "white")], "bold cyan")
    ...
    def handle_help_model(self) -> bool:
        ...
        # Usage table
        usage_table = create_styled_table("Usage", [("Command", "magenta"), ("Description", "white")])
    ...
    def handle_help_config(self) -> bool:
        ...
        table = create_styled_table("Available Subcommands", [("Command", "yellow"), ("Description", "white")])
        ...
        table.add_row("/config get <number>", "Get the value of a specific environment variable by its number")
        table.add_row(
    ...
    def handle_quickstart(self, _: Optional[list[str]] = None) -> bool:
        ...
        from skynet.repl.commands.base import handle_command
