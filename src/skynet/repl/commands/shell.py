...
from skynet.tools.common import _get_container_workspace_path, _get_workspace_dir
...
class ShellCommand(Command):
    ...
    def handle_shell_command(self, command_args: list[str]) -> bool:
        ...
        is_async = any(
            cmd in original_command for cmd in ["nc", "netcat", "ncat", "telnet", "ssh", "python -m http.server"]
        )
