...
def get_compact_model():
    try:
        from skynet.repl.commands.compact import get_compact_model as _get_compact_model
...
This session is being continued from a previous conversation that ran out of context. The conversation is summarized below:"""
    ...
    def _reload_agent_with_memory(self, agent_name: str, preserve_history: bool = True):
        ...
        try:
            ...
            from skynet.agents import get_agent_by_name, get_available_agents
            from skynet.sdk.agents.simple_agent_manager import AGENT_MANAGER
            ...
            if agent_id == "P1":
                ...
                try:
                    ...
                    if hasattr(skynet.cli, "agent"):
                        skynet.cli.agent = new_agent
                except Exception:
                    pass
