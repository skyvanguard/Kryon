...
from skynet.repl.commands import (  # pylint: disable=import-error,unused-import,line-too-long,redefined-builtin # noqa: E501,F401
    agent,
...
from skynet.repl.commands.base import (
    COMMAND_ALIASES,
    COMMANDS,
    Command,
    get_command,
...
from skynet.repl.commands.completer import FuzzyCommandCompleter
