...
from skynet.sdk.agents.simple_agent_manager import SimpleAgentManager, AGENT_MANAGER
...
from skynet.internal.components.metrics import process_intermediate_logs
...
if os.getenv("SKYNET_MODEL", os.getenv("SKYNET_MODEL", "gpt-4o")) == "o3-mini" or os.getenv("SKYNET_MODEL", os.getenv("SKYNET_MODEL", "gpt-4o")) == "gemini-1.5-pro":
...
class OpenAIChatCompletionsModel(Model):
    ...
    async def stream_response(
        ...
        try:
            ...
            should_show_rich_stream = (
                os.getenv("SKYNET_STREAM", "false").lower() == "true"
                    ...
                    async for chunk in stream:
                        ...
                        if reasoning_content:
                            if thinking_context:
                                ...
                                from skynet.util import update_claude_thinking_content
                        ...
                        if content:
                            ...
                            if thinking_context:
                                from skynet.util import finish_claude_thinking_display
        ...
        while retry_count < max_retries:
            try:
                ...
                if (
                    ...
                    try:
                        from skynet.util import print_message_history
    ...
    async def _auto_compact_if_needed(self, estimated_tokens: int, input: str | list[TResponseInputItem], system_instructions: str | None) -> tuple[str | list[TResponseInputItem], str | None, bool]:
        ...
        try:
            from skynet.repl.commands.memory import MEMORY_COMMAND_INSTANCE
            ...
            if summary:
                # Store the summary
                from skynet.repl.commands.memory import COMPACTED_SUMMARIES
