        ...
        with response_span(disabled=tracing.is_disabled()) as span_response:
            try:
                ...
                if _debug.DONT_LOG_MODEL_DATA:
                    ...
                    logger.debug(f"LLM resp:\n{json.dumps([x.model_dump() for x in response.output], indent=2)}\n")
                ...
                from skynet.util import cli_print_agent_messages
...
class Converter:
    ...
    @classmethod
    def get_response_format(cls, output_schema: AgentOutputSchema | None) -> ResponseTextConfigParam | NotGiven:
