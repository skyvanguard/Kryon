...
# Notification channels/rules are outbound-integration config (like the SIEM
# config in integrations.py) — gate the whole router behind integrations:read so
# a viewer can't create a channel/rule that exfiltrates other clients' findings;
# write endpoints additionally require integrations:write below.
router = APIRouter(
    tags=["notifications"],
    dependencies=[Depends(require_api_key), Depends(require_permission("integrations:read"))],
)
...
@router.post("/notifications/channels", dependencies=[Depends(require_permission("integrations:write"))])
...
@router.put("/notifications/channels/{channel_id}", dependencies=[Depends(require_permission("integrations:write"))])
...
@router.delete("/notifications/channels/{channel_id}", dependencies=[Depends(require_permission("integrations:write"))])
...
@router.post("/notifications/rules", dependencies=[Depends(require_permission("integrations:write"))])
...
@router.delete("/notifications/rules/{rule_id}", dependencies=[Depends(require_permission("integrations:write"))])
...
@router.post("/notifications/test/{channel_id}", dependencies=[Depends(require_permission("integrations:write"))])
