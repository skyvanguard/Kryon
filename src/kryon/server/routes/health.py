...
async def health_check() -> HealthResponse:
    ...
    # build_unified=False: count agents WITHOUT constructing the unified agent
    # (disk scan + a never-closed AsyncOpenAI client) on every probe.
    agents = get_available_agents(build_unified=False)
