...
@router.post(
    ...
    dependencies=[Depends(require_permission("engagements:write"))],
)
...
@router.post("/engagements/{engagement_id}/pause", dependencies=[Depends(require_permission("engagements:write"))])
...
@router.post("/engagements/{engagement_id}/resume", dependencies=[Depends(require_permission("engagements:write"))])
...
@router.delete("/engagements/{engagement_id}", dependencies=[Depends(require_permission("engagements:write"))])
