...
_ATTACK_VERBS = {
    "exploit", "explotar", "bypass", "bypassear",
    "escalate", "escalar", "pivot", "pivotear",
    "dump", "extract", "extraer", "read", "leer",
    "upload", "subir", "inject", "inyectar",
    "brute", "crack", "crackear",
    "fuzz", "enumerate", "enumerar",
    "audit", "auditar", "hardening",
    "forensic", "forense", "triage",
    "deobfuscate", "deobfuscar",
    "exfil", "persist", "persistir",
}
...
class IntentShiftDetector:
    ...
    def extract(self, text: str) -> IntentSignature:
        ...
        return IntentSignature(
            verbs=verbs, vectors=vectors, targets=targets, raw=text
        )
