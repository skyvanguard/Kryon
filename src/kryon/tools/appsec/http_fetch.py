...
def http_fetch(
    ...
    try:
        ...
        # Global research-identification header (KRYON_HTTP_EXTRA_HEADERS) sits
        # between the defaults and per-call headers so a caller can still override.
        merged_headers = {**_DEFAULT_HEADERS, **extra_http_headers(), **extra_headers}
