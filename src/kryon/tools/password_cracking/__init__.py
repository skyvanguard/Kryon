...
Example Usage:
    >>> from kryon.tools.password_cracking import hashcat_crack, john_crack
    >>> from kryon.tools.password_cracking import analyze_password_policy, generate_custom_wordlist
    >>>
