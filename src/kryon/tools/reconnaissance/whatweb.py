...
def whatweb_scan(
    ...
    # whatweb only accepts aggression 1, 3 or 4 (NOT 2). The model sometimes
    # picks 2 (reads like a valid "medium") and whatweb aborts with
    # "Agression level must be 1,3, or 4. 2 is invalid." Coerce: 2→3, anything
    # out of {1,3,4}→1 (passive default).
