...
_EXTENDED_CMS_SIGS: tuple[tuple[str, str, re.Pattern | None, str, re.Pattern | None], ...] = (
    ("CMS-050", "Ghost",
     ...
     "", None),
    ("CMS-050", "Ghost",
     re.compile(r"ghost-sdk|/ghost/api/", re.IGNORECASE),
     "", None),
    ("CMS-051", "Shopify",
    ...
    ("CMS-052", "Strapi",
     ...
     "x-powered-by", re.compile(r"strapi", re.IGNORECASE)),
    ("CMS-053", "MediaWiki",
     re.compile(r'<meta name="generator"\s+content="MediaWiki\s+(\d+\.\d+(?:\.\d+)?)?', re.IGNORECASE),
     "", None),
    ("CMS-054", "phpBB",
     re.compile(r"phpBB|generated by phpbb", re.IGNORECASE),
     "", None),
    ("CMS-055", "Discourse",
     re.compile(r"discourse|/discourse/", re.IGNORECASE),
     "x-discourse-route", re.compile(r".+")),
    ("CMS-055", "Discourse",
     re.compile(r"discourse|/discourse/", re.IGNORECASE),
     "", None),
    ("CMS-056", "vBulletin",
     re.compile(r"vbulletin|vbphrase", re.IGNORECASE),
     "", None),
    ("CMS-057", "Sitecore",
     re.compile(r"/sitecore/|sitecore_userticket", re.IGNORECASE),
     "", None),
    ("CMS-058", "Adobe Experience Manager (AEM)",
     re.compile(r"/etc/designs/|/content/dam/|cq-cmp", re.IGNORECASE),
     "", None),
    ("CMS-059", "Umbraco",
     re.compile(r"umbraco|/umbraco/", re.IGNORECASE),
     "", None),
    ("CMS-060", "Liferay",
     re.compile(r"liferay|/c/portal/", re.IGNORECASE),
     "", None),
    ("CMS-061", "Plone",
     re.compile(r'<meta name="generator"\s+content="Plone', re.IGNORECASE),
     "", None),
    ("CMS-062", "Concrete5/CMS",
     re.compile(r"concrete5|/concrete/", re.IGNORECASE),
     "", None),
    ("CMS-063", "Craft CMS",
     re.compile(r"craft cms|/cpresources/", re.IGNORECASE),
     "x-powered-by", re.compile(r"craft\s*cms", re.IGNORECASE)),
    ("CMS-063", "Craft CMS",
     re.compile(r"craft cms|/cpresources/", re.IGNORECASE),
     "", None),
    ("CMS-064", "October CMS",
     re.compile(r"october cms|/storage/temp/public/", re.IGNORECASE),
     "", None),
    ("CMS-065", "Statamic",
     re.compile(r"statamic|/_/img/", re.IGNORECASE),
     "x-statamic-version", re.compile(r".+")),
    ("CMS-066", "Webflow",
     re.compile(r"webflow|w-mod-js", re.IGNORECASE),
     "", None),
    ("CMS-067", "Squarespace",
     re.compile(r"squarespace|Static\.SQUARESPACE", re.IGNORECASE),
     "", None),
    ("CMS-068", "Wix",
     re.compile(r"static\.wixstatic\.com|wix-thunderbolt", re.IGNORECASE),
     "x-wix-request-id", re.compile(r".+")),
    ("CMS-068", "Wix",
     re.compile(r"static\.wixstatic\.com|wix-thunderbolt", re.IGNORECASE),
     "", None),
    ("CMS-070", "Next.js",
     re.compile(r"/_next/static/|__NEXT_DATA__", re.IGNORECASE),
     "x-powered-by", re.compile(r"next\.js", re.IGNORECASE)),
    ("CMS-070", "Next.js",
     re.compile(r"/_next/static/|__NEXT_DATA__", re.IGNORECASE),
     "", None),
    ("CMS-071", "Nuxt.js",
     re.compile(r"__NUXT__|/_nuxt/", re.IGNORECASE),
     "", None),
    ("CMS-072", "Gatsby",
     re.compile(r"gatsby-link|window\.___gatsby", re.IGNORECASE),
     "", None),
    ("CMS-073", "SvelteKit",
     re.compile(r"sveltekit|__sveltekit_", re.IGNORECASE),
     "", None),
    ("CMS-074", "Hugo (static)",
     re.compile(r'<meta name="generator"\s+content="Hugo\s+(\d+\.\d+(?:\.\d+)?)?', re.IGNORECASE),
     "", None),
    ("CMS-075", "Jekyll (static)",
