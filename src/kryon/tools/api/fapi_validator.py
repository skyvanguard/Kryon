...
Version note (2026-07): FAPI 1.0 Advanced (Final, Mar 2021) is still the
profile mandated by the major Open Banking regimes above. FAPI 2.0 Security
Profile reached Final in Feb 2025 — simpler, formally analysed, roughly the
FAPI 1.0 Advanced threat model — and is the forward path, but not yet required
by the banks Kryon targets. This validator checks the 1.0 Advanced profile.
