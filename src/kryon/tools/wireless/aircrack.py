...
@function_tool
def aircrack_crack(
    capture_file: str, wordlist: str, bssid: str = "", essid: str = "", threads: int = 1, ctf=None
) -> str:
    """
...
@function_tool
def aircrack_deauth(
    interface: str, bssid: str, client: str = "", count: int = 1, reason_code: int = 7, ctf=None
) -> str:
    """
...
@function_tool
def aircrack_injection_test(interface: str, bssid: str = "", essid: str = "", ctf=None) -> str:
    """
