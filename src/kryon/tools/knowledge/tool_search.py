...
def tool_search(query: str) -> str:
    ...
    if not inventory:
        return "ERROR: tool inventory empty (import failure). Fallback: try `request_skill(topic=...)` directly."
    ...
    if not top:
        ...
        default_names = ["web_fetch_smart", "duckduckgo_search", "run_command", "request_skill", "tool_search"]
