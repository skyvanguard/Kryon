...
def generate_beacon(
    ...
    Example:
        >>> from kryon.tools.command_and_control import generate_beacon
        >>>
...
def obfuscate_beacon(beacon_code: str, method: str = "base64") -> dict[str, Any]:
    ...
    Example:
        >>> from kryon.tools.command_and_control import obfuscate_beacon
        >>>
...
def generate_stager(beacon_url: str, platform: str = "powershell") -> dict[str, Any]:
    ...
    Example:
        >>> from kryon.tools.command_and_control import generate_stager
        >>>
...
def generate_payload_variants(base_payload: str, num_variants: int = 5) -> dict[str, Any]:
    ...
    Example:
        >>> from kryon.tools.command_and_control import generate_payload_variants
        >>>
