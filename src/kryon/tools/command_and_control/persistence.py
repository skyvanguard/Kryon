...
def create_registry_persistence(
    ...
    Example:
        >>> from kryon.tools.command_and_control import create_registry_persistence
        >>>
...
def create_scheduled_task(
    ...
    Example:
        >>> from kryon.tools.command_and_control import create_scheduled_task
        >>>
...
def create_service_persistence(
    ...
    Example:
        >>> from kryon.tools.command_and_control import create_service_persistence
        >>>
...
def create_startup_folder_persistence(
    ...
    Example:
        >>> from kryon.tools.command_and_control import create_startup_folder_persistence
        >>>
...
def create_wmi_persistence(
    ...
    Example:
        >>> from kryon.tools.command_and_control import create_wmi_persistence
        >>>
...
def create_dll_hijacking(dll_name: str, target_application: str, payload_dll_path: str) -> dict[str, Any]:
    ...
    Example:
        >>> from kryon.tools.command_and_control import create_dll_hijacking
        >>>
...
def create_com_hijacking(clsid: str, payload_dll_path: str) -> dict[str, Any]:
    ...
    Example:
        >>> from kryon.tools.command_and_control import create_com_hijacking
        >>>
        >>> # Hijack COM object
...
def escalate_privileges(method: str = "uac_bypass", payload_path: str = "") -> dict[str, Any]:
    ...
    Example:
        >>> from kryon.tools.command_and_control import escalate_privileges
        >>>
        >>> # UAC bypass
