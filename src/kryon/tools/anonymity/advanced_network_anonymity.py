...
def multi_hop_ssh_tunnel(hops: list[dict[str, str]], local_port: int = 8080, final_port: int = 80) -> dict[str, Any]:
    ...
    Example:
        >>> from kryon.tools.anonymity import multi_hop_ssh_tunnel
        >>>
        >>> # Create 3-hop tunnel
...
def shadowsocks_setup(
    ...
    Example:
        >>> from kryon.tools.anonymity import shadowsocks_setup
        >>>
...
def obfs4_bridge() -> dict[str, Any]:
    ...
    Example:
        >>> from kryon.tools.anonymity import obfs4_bridge
        >>>
        >>> # Setup obfs4
        >>> bridge = obfs4_bridge()
    """
...
def vmess_protocol() -> dict[str, Any]:
    ...
    Example:
        >>> from kryon.tools.anonymity import vmess_protocol
        >>>
        >>> # Setup VMess
...
def wireguard_mesh(peers: list[dict[str, str]], interface: str = "wg0") -> dict[str, Any]:
    ...
    Example:
        >>> from kryon.tools.anonymity import wireguard_mesh
        >>>
        >>> # Setup mesh VPN
        >>> mesh = wireguard_mesh(
        ...     peers=[
...
def anonymous_dns_over_https(providers: list[str] = None) -> dict[str, Any]:
    """
    ...
    Example:
        >>> from kryon.tools.anonymity import anonymous_dns_over_https
        >>>
        >>> # Setup DoH
...
def decoy_routing() -> dict[str, Any]:
    ...
    Example:
        >>> from kryon.tools.anonymity import decoy_routing
        >>>
