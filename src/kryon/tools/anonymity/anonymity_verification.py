...
def check_ip_leak(expected_country: Optional[str] = None) -> dict[str, Any]:
    ...
    Example:
        >>> from kryon.tools.anonymity import check_ip_leak
        >>>
...
def check_dns_leak(expected_dns_servers: Optional[list[str]] = None) -> dict[str, Any]:
    ...
    Example:
        >>> from kryon.tools.anonymity import check_dns_leak
        >>>
        >>> # Check DNS leak
...
def check_webrtc_leak() -> dict[str, Any]:
    ...
    Example:
        >>> from kryon.tools.anonymity import check_webrtc_leak
        >>>
        >>> # Check WebRTC leak
...
def check_timezone_leak() -> dict[str, Any]:
    ...
    Example:
        >>> from kryon.tools.anonymity import check_timezone_leak
        >>>
        >>> # Check timezone
...
def check_fingerprint_uniqueness(fingerprint_data: dict[str, Any]) -> dict[str, Any]:
    ...
    Example:
        >>> from kryon.tools.anonymity import check_fingerprint_uniqueness
        >>>
        >>> # Analyze fingerprint
        >>> fingerprint = {
...
def comprehensive_anonymity_check(expected_country: Optional[str] = None) -> dict[str, Any]:
    ...
    Example:
        >>> from kryon.tools.anonymity import comprehensive_anonymity_check
        >>>
...
def anonymity_score() -> dict[str, Any]:
    ...
    Example:
        >>> from kryon.tools.anonymity import anonymity_score
        >>>
