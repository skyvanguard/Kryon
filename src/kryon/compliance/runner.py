...
def _import_all_checks() -> None:
    ...
    modules = [
        ...
        "kryon.compliance.checks.section_1.c_1_4_1_host_firewall",
        "kryon.compliance.checks.section_2.c_2_2_5_insecure_services",
        "kryon.compliance.checks.section_4.c_4_2_1_strong_tls",
        "kryon.compliance.checks.section_5.c_5_2_1_antimalware",
        "kryon.compliance.checks.section_6.c_6_4_1_web_headers",
        "kryon.compliance.checks.section_6.c_6_4_3_payment_scripts",
        "kryon.compliance.checks.section_7.c_7_2_1_sensitive_file_perms",
        "kryon.compliance.checks.section_8.c_8_2_1_unique_ids",
        "kryon.compliance.checks.section_8.c_8_3_6_password_policy",
        "kryon.compliance.checks.section_8.c_8_4_3_mfa",
        "kryon.compliance.checks.section_10.c_10_3_1_audit_log_protection",
        "kryon.compliance.checks.section_10.c_10_6_1_time_sync",
        "kryon.compliance.checks.section_11.c_11_5_1_ids_ips",
        ...
        "kryon.compliance.checks.proxmox.c_pve_2_2_fail2ban",
        "kryon.compliance.checks.proxmox.c_pve_2_3_ssh_ciphers",
        "kryon.compliance.checks.proxmox.c_pve_2_4_kernel_sysctl",
        "kryon.compliance.checks.proxmox.c_pve_3_3_named_users",
        "kryon.compliance.checks.proxmox.c_pve_4_2_firewall_logging",
        "kryon.compliance.checks.proxmox.c_pve_5_2_repo_hygiene",
        "kryon.compliance.checks.proxmox.c_pve_5_3_unattended_upgrades",
        "kryon.compliance.checks.proxmox.c_pve_6_1_cluster_quorum",
        "kryon.compliance.checks.proxmox.c_pve_7_1_time_sync",
        "kryon.compliance.checks.proxmox.c_pve_8_1_backup_jobs",
        ...
        "kryon.compliance.checks.fortigate.c_fgt_1_7_admin_gui_tls",
        "kryon.compliance.checks.fortigate.c_fgt_1_8_password_policy",
        "kryon.compliance.checks.fortigate.c_fgt_1_9_maintainer",
        ...
        "kryon.compliance.checks.fortigate.c_fgt_2_5_strong_crypto",
        ...
        "kryon.compliance.checks.fortigate.c_fgt_6_1_allow_all_policies",
        "kryon.compliance.checks.fortigate.c_fgt_6_2_policy_logging",
        "kryon.compliance.checks.fortigate.c_fgt_6_3_policy_utm_profiles",
        ...
        "kryon.compliance.checks.vmware.c_esx_1_1_shell_timeout",
        "kryon.compliance.checks.vmware.c_esx_1_2_mob_disabled",
        "kryon.compliance.checks.vmware.c_esx_1_3_dcui_timeout",
        "kryon.compliance.checks.vmware.c_esx_1_4_shell_service_timeout",
        "kryon.compliance.checks.vmware.c_esx_2_1_account_lockout",
        "kryon.compliance.checks.vmware.c_esx_2_2_account_unlock_time",
        "kryon.compliance.checks.vmware.c_esx_2_3_login_banner",
        "kryon.compliance.checks.vmware.c_esx_3_1_ntp",
        "kryon.compliance.checks.vmware.c_esx_3_2_remote_syslog",
        "kryon.compliance.checks.vmware.c_esx_3_3_ntp_firewall",
        "kryon.compliance.checks.vmware.c_esx_4_1_firewall",
        "kryon.compliance.checks.vmware.c_esx_4_2_snmp",
        "kryon.compliance.checks.vmware.c_esx_4_3_vswitch_security",
        "kryon.compliance.checks.vmware.c_esx_5_1_password_complexity",
        "kryon.compliance.checks.vmware.c_esx_5_2_password_history",
        "kryon.compliance.checks.vmware.c_esx_6_1_weak_tls",
        "kryon.compliance.checks.vmware.c_esx_6_2_vib_acceptance",
        "kryon.compliance.checks.kvm.c_kvm_1_1_libvirtd_tcp_auth",
        "kryon.compliance.checks.kvm.c_kvm_1_2_socket_perms",
        "kryon.compliance.checks.kvm.c_kvm_1_3_audit_logging",
        "kryon.compliance.checks.kvm.c_kvm_1_4_tls_key_perms",
        "kryon.compliance.checks.kvm.c_kvm_1_5_tls_verify",
        "kryon.compliance.checks.kvm.c_kvm_2_1_svirt",
        "kryon.compliance.checks.kvm.c_kvm_2_2_vnc_exposure",
        "kryon.compliance.checks.kvm.c_kvm_2_3_spice_exposure",
        "kryon.compliance.checks.kvm.c_kvm_3_1_qemu_nonroot",
        "kryon.compliance.checks.kvm.c_kvm_3_2_image_perms",
        "kryon.compliance.checks.kvm.c_kvm_3_3_seccomp",
        "kryon.compliance.checks.kvm.c_kvm_3_4_clear_capabilities",
        "kryon.compliance.checks.kvm.c_kvm_3_5_namespaces",
        "kryon.compliance.checks.kvm.c_kvm_3_6_device_acl",
        "kryon.compliance.checks.hyperv.c_hv_1_1_mac_spoofing",
        "kryon.compliance.checks.hyperv.c_hv_1_2_automatic_stop",
        "kryon.compliance.checks.hyperv.c_hv_1_3_admins_group",
        "kryon.compliance.checks.hyperv.c_hv_2_1_secure_boot",
        "kryon.compliance.checks.hyperv.c_hv_2_2_guest_file_copy",
        "kryon.compliance.checks.hyperv.c_hv_2_3_production_checkpoints",
        "kryon.compliance.checks.hyperv.c_hv_2_4_automatic_checkpoints",
        "kryon.compliance.checks.hyperv.c_hv_3_1_migration_auth",
        "kryon.compliance.checks.hyperv.c_hv_3_2_nested_virt",
        "kryon.compliance.checks.xen.c_xen_1_1_ssh_keyonly",
        "kryon.compliance.checks.xen.c_xen_1_2_time_sync",
        "kryon.compliance.checks.xen.c_xen_1_3_remote_syslog",
        "kryon.compliance.checks.xen.c_xen_2_1_version",
        "kryon.compliance.checks.xen.c_xen_2_2_patches",
        "kryon.compliance.checks.mikrotik.c_mtk_1_1_insecure_services",
        "kryon.compliance.checks.mikrotik.c_mtk_1_2_ssh_strong_crypto",
        "kryon.compliance.checks.mikrotik.c_mtk_1_3_bandwidth_server",
        "kryon.compliance.checks.mikrotik.c_mtk_2_1_ntp_client",
        "kryon.compliance.checks.mikrotik.c_mtk_2_2_snmp_community",
        "kryon.compliance.checks.mikrotik.c_mtk_2_3_remote_logging",
        "kryon.compliance.checks.postgres.c_pg_1_1_ssl",
        "kryon.compliance.checks.postgres.c_pg_1_2_log_connections",
        "kryon.compliance.checks.postgres.c_pg_1_3_log_disconnections",
        "kryon.compliance.checks.postgres.c_pg_2_1_password_encryption",
        "kryon.compliance.checks.postgres.c_pg_2_2_no_network_trust",
        "kryon.compliance.checks.mysql.c_mysql_1_1_require_tls",
        "kryon.compliance.checks.mysql.c_mysql_1_2_local_infile",
        "kryon.compliance.checks.mysql.c_mysql_2_1_anonymous_users",
        "kryon.compliance.checks.mysql.c_mysql_2_2_root_any_host",
        "kryon.compliance.checks.mysql.c_mysql_2_3_test_database",
        "kryon.compliance.checks.nginx.c_ngx_1_1_server_tokens",
        "kryon.compliance.checks.nginx.c_ngx_1_2_ssl_protocols",
        "kryon.compliance.checks.nginx.c_ngx_1_3_autoindex",
        "kryon.compliance.checks.nginx.c_ngx_2_1_worker_user",
        "kryon.compliance.checks.apache.c_apache_1_1_server_tokens",
        "kryon.compliance.checks.apache.c_apache_1_2_server_signature",
        "kryon.compliance.checks.apache.c_apache_2_1_indexes",
        "kryon.compliance.checks.apache.c_apache_2_2_trace",
        "kryon.compliance.checks.linux.c_lnx_1_1_root_login",
        "kryon.compliance.checks.linux.c_lnx_1_2_empty_passwords_ssh",
        "kryon.compliance.checks.linux.c_lnx_2_1_shadow_empty_password",
        "kryon.compliance.checks.linux.c_lnx_2_2_uid0",
        "kryon.compliance.checks.linux.c_lnx_2_3_shadow_perms",
        "kryon.compliance.checks.cisco.c_ios_1_1_vty_ssh",
        "kryon.compliance.checks.cisco.c_ios_1_2_enable_secret",
        "kryon.compliance.checks.cisco.c_ios_1_3_password_encryption",
        "kryon.compliance.checks.cisco.c_ios_2_1_snmp_community",
        "kryon.compliance.checks.cisco.c_ios_2_2_http_server",
        "kryon.compliance.checks.haproxy.c_hap_1_1_weak_tls",
        "kryon.compliance.checks.haproxy.c_hap_1_2_stats_auth",
        "kryon.compliance.checks.haproxy.c_hap_1_3_logging",
        "kryon.compliance.checks.haproxy.c_hap_2_1_admin_socket",
        "kryon.compliance.checks.iis.c_iis_1_1_directory_browse",
        "kryon.compliance.checks.iis.c_iis_1_2_detailed_errors",
        "kryon.compliance.checks.iis.c_iis_1_3_server_header",
        "kryon.compliance.checks.iis.c_iis_2_1_logging",
        "kryon.compliance.checks.caddy.c_caddy_1_1_admin_exposure",
        "kryon.compliance.checks.caddy.c_caddy_1_2_auto_https",
        "kryon.compliance.checks.caddy.c_caddy_1_3_tls_protocols",
        "kryon.compliance.checks.caddy.c_caddy_2_1_file_browse",
