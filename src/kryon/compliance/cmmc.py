...
Level 2 (Advanced) aligns 1:1 with NIST SP 800-171 **Rev 2** (110 practices);
the ids follow the CMMC-XX.L2-3.x.x scheme. NOTE: NIST SP 800-171 Rev 3
(May 2024 — 97 controls + ODPs) does NOT apply to CMMC yet. C3PAO assessors
benchmark against Rev 2, and CMMC Phase 2 (starts Nov 2026) still uses Rev 2.
Do NOT migrate these ids to Rev 3 until the DoD formally requires it (future
rulemaking, years out). Verified current as of 2026-07.
"""
