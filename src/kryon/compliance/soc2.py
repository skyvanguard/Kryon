...
Based on the AICPA TSP Section 100 — 2017 Trust Services Criteria (with revised
points of focus – 2022), the current standard as of 2026-07. Five categories:
Security (Common Criteria CC1–CC9), Availability, Processing Integrity,
Confidentiality, Privacy. The 2022 revision updated the points-of-focus
guidance, not the criteria themselves (stable since 2017).
"""
...
SOC2_TSC_CONTROLS: list[ComplianceControl] = [
    ...
    ComplianceControl(
        ...
        expected_evidence=["Access policy", "Config"],
    ),
    ComplianceControl(
        id="CC6.2",
        title="User Registration and Authorization",
        description="New users are registered and authorized",
        category="Security",
        testing_procedures=["User provisioning review"],
        expected_evidence=["Provisioning process"],
    ),
    ComplianceControl(
        id="CC6.3",
        title="Role-Based Access",
        description="Role-based access controls are used to support segregation of duties",
        category="Security",
        testing_procedures=["RBAC review"],
        expected_evidence=["Role matrix"],
    ),
    ComplianceControl(
        id="CC6.6",
        title="System Boundaries Security",
        description="System boundaries are secured against unauthorized access",
        category="Security",
        testing_procedures=["Perimeter testing"],
        expected_evidence=["Firewall config"],
    ),
    ComplianceControl(
        id="CC6.7",
        title="Transmission Security",
        description="Data transmitted between boundaries is protected",
        category="Security",
        testing_procedures=["Encryption testing"],
    ...
    ComplianceControl(
        ...
        expected_evidence=["AV reports"],
    ),
    ComplianceControl(
        id="CC7.1",
        title="Monitoring Activities",
        description="Monitoring of infrastructure and software for anomalies",
        category="Security",
        testing_procedures=["Log review"],
        expected_evidence=["Monitoring config"],
    ),
    ComplianceControl(
        id="CC7.2",
        title="Anomaly Detection",
        description="Anomalies are investigated and remediated",
        category="Security",
        testing_procedures=["Incident review"],
        expected_evidence=["Incident logs"],
    ),
    ComplianceControl(
        id="CC7.3",
        title="Vulnerability Management",
        description="Vulnerabilities are identified, assessed, and remediated",
        category="Security",
        testing_procedures=["Vuln scanning"],
    ...
    ComplianceControl(
        ...
        category="Security",
        testing_procedures=["Change review"],
        expected_evidence=["Change logs"],
    ),
    # Availability
    ComplianceControl(
        id="A1.1",
        ...
        testing_procedures=["Capacity review"],
        expected_evidence=["Capacity reports"],
    ),
    ComplianceControl(
        id="A1.2",
        title="Recovery Planning",
        description="Recovery operations are planned and tested",
        category="Availability",
        testing_procedures=["DR test review"],
        expected_evidence=["DR test results"],
    ),
    ...
    ComplianceControl(
        ...
        testing_procedures=["Data integrity review"],
        expected_evidence=["Validation logs"],
    ),
    # Confidentiality
    ComplianceControl(
        id="C1.1",
        ...
        testing_procedures=["Classification review"],
        expected_evidence=["Classification policy"],
    ),
    ComplianceControl(
        id="C1.2",
        title="Confidential Information Disposal",
        description="Confidential information is destroyed when no longer needed",
        category="Confidentiality",
        testing_procedures=["Disposal review"],
        expected_evidence=["Disposal records"],
    ),
    # Privacy
    ComplianceControl(
        id="P1.1",
        ...
        category="Privacy",
        testing_procedures=["Notice review"],
        expected_evidence=["Privacy policy"],
    ),
    ComplianceControl(
        id="P6.1",
        title="Data Quality",
        description="Personal information is accurate and complete",
        category="Privacy",
        testing_procedures=["Data quality review"],
        expected_evidence=["Data audit"],
    ),
]
