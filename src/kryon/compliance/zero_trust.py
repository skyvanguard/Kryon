...
Aligned to the CISA Zero Trust Maturity Model (ZTMM) **v2.0** (Apr 2023) — the
current version as of 2026-07 (no v3.0). Five pillars (Identity, Devices,
Networks, Applications & Workloads, Data) plus cross-cutting capabilities
(Visibility & Analytics, Automation & Orchestration, Governance). Foundational
