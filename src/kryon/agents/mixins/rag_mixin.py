...
class RAGMixin:
    ...
    def query_rag(
        ...
        from kryon.knowledge.query_cache import cache_query, get_cached_query
        ...
        # Query RAG
        result = query_knowledge(question, top_k=top_k, source_filter=source_filter, use_llm=use_llm)
