...
DEFAULT_TOOL_POLICIES: dict[str, ToolPolicy] = {
    ...
    "analyst": ToolPolicy(
        role="analyst",
        allowed_tools=[
            "nmap_scan", "nikto_scan", "web_search", "dns_query",
            "whois_lookup", "ssl_check", "port_scan", "subdomain_enum",
            "dir_brute", "vuln_scan", "http_request", "shodan_search",
            "nuclei_scan", "wpscan", "sqlmap_scan", "xss_scan",
            "web_crawl", "screenshot", "tech_detect",
        ],
