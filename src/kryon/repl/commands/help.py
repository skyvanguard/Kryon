...
from kryon.repl.commands.base import COMMAND_ALIASES, COMMANDS, Command, register_command

try:
    from kryonextensions.platform.base import platform_manager as _  # noqa: F401
...
class HelpCommand(Command):
    ...
    def handle_help_platform_manager(self) -> bool:
        ...
        if HAS_PLATFORM_EXTENSIONS and is_kryon_extensions_platform_available():
            try:
                from kryonextensions.platform.base import platform_manager
    ...
    def handle_quickstart(self, _: Optional[list[str]] = None) -> bool:
        ...
        from kryon.repl.commands.base import handle_command
