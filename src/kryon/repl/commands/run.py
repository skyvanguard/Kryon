...
class RunCommand(Command):
    ...
    def __init__(self):
        ...
        super().__init__(name="/run", description="Execute queued prompts in parallel mode", aliases=["/r"])
    ...
    def handle(self, args: Optional[list[str]] = None) -> bool:
        ...
        if not QUEUED_PROMPTS:
            console.print("[yellow]No prompts queued. Use '/run queue <agent> <prompt>' to add prompts.[/yellow]")
            return True
        ...
        console.print("[cyan]Prompts configured for parallel execution. Processing will begin now.[/cyan]")
