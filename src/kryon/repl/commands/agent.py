...
# Local imports
from kryon.agents import get_agent_module, get_available_agents
from kryon.repl.commands.base import Command, register_command
from kryon.sdk.agents import Agent
from kryon.util import visualize_agent_graph
...
class AgentCommand(Command):
    ...
    def handle_select(self, args: list[str] | None = None) -> bool:  # pylint: disable=too-many-branches,line-too-long # noqa: E501
        ...
        from kryon.repl.commands.parallel import PARALLEL_AGENT_INSTANCES, PARALLEL_CONFIGS
        from kryon.sdk.agents.simple_agent_manager import AGENT_MANAGER
