...
class PlatformCommand(Command):
    ...
    def handle_vpn_status(self, args: list[str] | None = None) -> bool:  # pylint: disable=unused-argument # noqa: E501
        ...
        try:
            from kryonextensions.platform.htb.cli import (  # pylint: disable=import-error,import-outside-toplevel,line-too-long # noqa: E501
                get_vpn_ip,
                is_vpn_connected,
                vpn_active,
            )
    ...
    def handle_keep_vpn(self, args: list[str] | None = None) -> bool:  # pylint: disable=unused-argument # noqa: E501
        ...
        try:
            ...
            import kryonextensions.platform.htb.cli as htb_cli  # pylint: disable=import-error,import-outside-toplevel,line-too-long # noqa: E501
