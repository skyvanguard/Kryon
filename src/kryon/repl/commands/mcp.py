...
from kryon.sdk.agents.mcp import (
    MCPServer,
    MCPServerSse,
    MCPServerSseParams,
    MCPServerStdio,
...
class GlobalMCPUtil(MCPUtil):
    ...
    def to_function_tool(cls, tool, server_name: str) -> FunctionTool:
        ...
        async def invoke_with_fresh_connection(config, context, input_json):
            ...
            from kryon.sdk.agents.exceptions import AgentsException, ModelBehaviorError
            from kryon.sdk.agents.mcp import MCPServerSse, MCPServerStdio
            ...
            from kryon.sdk.agents.tracing import FunctionSpanData, get_current_span
