...
from kryon.repl.commands.base import COMMAND_ALIASES, COMMANDS
from kryon.repl.commands.model import get_predefined_model_names
...
class FuzzyCommandCompleter(Completer):
    ...
    def get_mcp_server_suggestions(self, current_word: str) -> list[Completion]:
        ...
        try:
            ...
            from kryon.repl.commands.mcp import _GLOBAL_MCP_SERVERS
