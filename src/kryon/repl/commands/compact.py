...
from kryon.repl.commands.model import (
...
class CompactCommand(Command):
    ...
    def _perform_parallel_compaction(self) -> bool:
        ...
        from kryon.repl.commands.parallel import PARALLEL_CONFIGS
        from kryon.sdk.agents.models.openai_chatcompletions import get_agent_message_history
        ...
        **kwargs,
        ...
        try:
            ...
            if self.compact_model:
                ...
                original_model = os.environ.get("KRYON_MODEL", "kryon-local")
