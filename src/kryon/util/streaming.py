    ...
    try:
        ...
        if token_stats:
            ...
            if input_tokens > 0:
                ...
                model_name = context.get("model", os.environ.get("KRYON_MODEL", "kryon-devstral-24b"))
    ...
    try:
        ...
        if final_stats:
            ...
            if not isinstance(model_name, str):
                model_name = os.environ.get("KRYON_MODEL", "kryon-devstral-24b")
...
def finish_tool_streaming(tool_name, args, output, call_id, execution_info=None, token_info=None):
    ...
    if token_info:
        ...
        if not interaction_cost and input_tokens > 0:
            model_name = token_info.get("model", os.environ.get("KRYON_MODEL", "kryon-devstral-24b"))
