...
class FunctionToolResult:
    ...
    tool_call: Any = None
    """The originating tool call (ResponseFunctionToolCall, carries ``.arguments``). ``run_item`` is the
    OUTPUT item (call_id/output/type) and has no arguments — the StuckDetector and audit log need the
    call's args to tell distinct invocations apart, so we thread the call object through here."""
