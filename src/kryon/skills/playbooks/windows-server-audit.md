...
```
Host: WS-01.example.local (Windows 11 Enterprise 22H2)
...
Para un engagement interno (p.ej. segmentos de workstations 192.0.2.0/24
y 198.51.100.0/24, además de cualquier Windows Server en los segmentos
de servidores), el audit corre via WinRM si está habilitado; en hosts donde
WinRM no esté disponible, el operador debe habilitarlo via GPO antes
de la ventana del engagement.
