...
triggers:
  ...
  # UniFi controller fingerprint ports only — 8843/8880 = guest portal,
  # 6789 = throughput, 5514 = remote syslog, 27117 = controller MongoDB.
  # Generic 8443/8080/22 false-matched onto any host (+ generate_compliance_pdf).
  ports: [8843, 8880, 6789, 5514, 27117]
  keywords:
    - "unifi"
    - "ubiquiti"
    - "ubnt"
...
- **Para UNF-1.4**: `cve_intel(query="unifi network X.Y.Z")`.
