...
triggers:
  ...
  # FortiGate fingerprint ports only — generic 443/8443/22 (on every host)
  # false-matched this heavy audit skill (+ generate_compliance_pdf) onto any
  # HTTPS target. 10443/4433 = SSL-VPN, 541/542 = FortiManager/FortiGuard.
  ports: [10443, 4433, 541, 542]
  keywords:
    - "fortigate"
    - "fortinet"
    - "fortios"
...
| FGT-5.3 | CRITICAL | Versión vulnerable a CVE crítico no parchado (CVE-2022-42475, CVE-2024-21762, etc.) | Cross-ref con `cve_intel` |
...
- **CVE-2022-42475 / CVE-2023-27997 sin parchar** — 1-2 de 10. CRITICAL,
  exploit público disponible. Cruzar con `cve_intel`.
...
- **Durante FGT-5.3**: `cve_intel(query="FortiOS X.Y.Z")`
