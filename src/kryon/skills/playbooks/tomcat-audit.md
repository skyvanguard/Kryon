...
triggers:
  ...
  ports: [8080, 8009, 8443, 8005, 8000]
  keywords:
    - "tomcat"
    - "apache tomcat"
    - "apache-coyote"
...
Surfaceado en el POC piloto Britimp 2026-05-18 contra .11
...
## CVE corpus (cross-ref con `search_vulnerabilities`)
...
```
Host: 172.18.201.11 (Apache Tomcat 7.0.34, JSP app "Pages/login.jsp")
Findings:
