...
description: "Bypass de autenticación vía forced browsing — /admin sin auth, IDOR, path traversal"
triggers:
  tech: ["apache", "nginx", "iis", "php", "wordpress"]
  ports: [80, 443, 8080, 8443]
  keywords: ["forced browsing", "idor", "auth bypass", "broken access", "privilege escalation web", "a01"]
priority: 18
required_tools:
  - run_command
  - nuclei_scan
