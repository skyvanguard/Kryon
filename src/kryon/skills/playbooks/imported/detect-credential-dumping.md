...
description: "Detección de técnicas de credential dumping — mimikatz, LSASS, SAM, shadow"
triggers:
  tech: ["windows", "linux"]
  ports: []
  keywords: ["mimikatz", "credential dump", "lsass", "sam hive", "shadow", "pth", "pass the hash", "dcsync"]
priority: 25
required_tools:
  - run_command
