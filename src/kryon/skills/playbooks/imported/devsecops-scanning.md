...
description: "Integrates Static Application Security Testing (SAST), Dynamic Application Security Testing (DAST), and Software Composition Analysis (SCA) into CI/CD pipelines using open-source tools. Covers Semgrep"
triggers:
  tech: []
  ports: []
  keywords:
...
> **Source**: Anthropic-Cybersecurity-Skills `implementing-devsecops-security-scanning` v1.0.0 (mahipal, Apache-2.0)
> **Upstream**: https://github.com/mukul975/Anthropic-Cybersecurity-Skills
> **NIST CSF**: PR.PS-01, PR.PS-04, ID.RA-01, PR.DS-10
