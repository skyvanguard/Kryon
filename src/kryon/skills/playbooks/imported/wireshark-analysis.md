...
description: "Análisis de tráfico de red con Wireshark/tshark — malware C2, exfiltración, protocolos"
triggers:
  tech: []
  ports: []
  keywords: ["wireshark", "tshark", "pcap", "packet capture", "trafico", "c2 detection", "exfiltration"]
priority: 25
required_tools:
  - run_command
---
