...
description: "Análisis forense de memoria con Volatility 3 — detect malware, rootkits, injected code"
triggers:
  tech: []
  ports: []
  keywords: ["memory dump", "volatility", "memoria", "rootkit", "injection", "lsass dump", "forensic memory"]
priority: 25
required_tools:
  - run_command
  - execute_code
